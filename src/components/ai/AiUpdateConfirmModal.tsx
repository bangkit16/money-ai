...
const styles = StyleSheet.create({
  ...
  changeLabel: { fontSize: 13, minWidth: 80 },
  changeValues: { flexDirection: "row", alignItems: "center", gap: 8, flexShrink: 1 },
  oldValue: { fontSize: 13, textDecorationLine: "line-through" },
  arrow: { fontSize: 14 },
  newValue: { fontSize: 14, fontWeight: "600" },
